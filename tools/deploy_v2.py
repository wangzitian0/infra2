...
def deploy_v2(
    *,
    ...
    # iac_ref is the recorded authority. A PR can supply an exact SHA plus its cloneable
    # head branch, but the branch must resolve to that same SHA; never broaden the
    # production ref contract merely to let a preview clone PR source.
    ...
    if iac_clone_ref is not None:
        ...
        # A raw SHA cannot be passed to GitHub's branch clone field (#342).
