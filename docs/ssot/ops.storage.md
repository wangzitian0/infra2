...
| **备份归档** | **Cloudflare R2** | 异地冷备（off-host）。清单见 [`ops.backup-inventory.yaml`](./ops.backup-inventory.yaml)；GitHub Actions 调度必须先登记到 [ops.pipeline.md](./ops.pipeline.md) 的 live workflow set，验证见 [`ops.recovery.md`](./ops.recovery.md) SOP-004/005 |
