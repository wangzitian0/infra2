...
| **Infra-012.8** | Weekly digest job runs every Monday 9 AM: queries SigNoz for previous 7 days of probe logs, aggregates by component + failure_domain, calculates success rate, sends Lark message to dedicated #watchdog-digest channel with format: "Week of Jun-02: 10,500 runs, 10,450 success (99.5%), failures: 40 network (60%), 20 resource (30%), 5 config (10%)." | **Metric**: By second week, report identifies 1-2 recurring failure patterns (e.g., "Redis flaps on Mondays at 2-3 AM"). |
