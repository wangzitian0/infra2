...
| **P0: SSOT Update** | `watchdog-signals.yaml`, `ops.observability.md` | Expand SSOT to include all probes/targets; update cadence and failure_domain taxonomy. Code and docs must match. | Changing probe definitions |
