...
> **状态**: Archived — Completed 2026-01-24  
> **开始时间**: 2026-01-21  
> **完成时间**: 2026-01-24  
...
>
> **历史记录说明（2026-09-15 归档）**：本文与下方并入的完成报告记录的是 2026-01 的状态。其中描述的
> 「push to main → GitHub webhook → IaC Runner → `invoke {service}.sync`」触发模型**已退役**：`/webhook`
> 如今只验签、不部署；staging 随 release tag 经 `reconcile-iac-inputs.yml` 自动晋升，prod 显式 promote。
> 现行模型见 [ops.pipeline.md](../../ssot/ops.pipeline.md) §2–3。
...
## 完成报告（merged from Infra-010.SUMMARY.md）

> 原 `Infra-010.SUMMARY.md`，2026-09-15 归档时并入（#713）。内容为 2026-01-21 的快照，触发模型见上方历史记录说明。
