...
- [x] `bootstrap/06.iac_runner` and `finance/wealthfolio`: removed mixed Dokploy-domain plus compose-Traefik routing ownership; enforced by `libs/tests/test_domain_routing_policy.py`
