...
| **Port** | `5432` |
| **Vault 路径** | `secret/platform/production/postgres` |
...
| **Host** | `platform-redis` |
| **Port** | `6379` |
| **Vault 路径** | `secret/platform/production/redis` |
...
```bash
vault kv get -field=PG_USER secret/platform/production/my-app
vault kv get -field=PG_PASS secret/platform/production/my-app
vault kv get -field=password secret/platform/production/redis
```
