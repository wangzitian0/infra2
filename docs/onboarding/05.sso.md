...
提供以下信息：
- 应用名称：`my-app`
- Redirect URI：`https://my-app${ENV_SUFFIX}.${INTERNAL_DOMAIN}/auth/callback`

**方式 2: 自己在 Authentik UI 创建**

1. 登录 `https://sso${ENV_SUFFIX}.${INTERNAL_DOMAIN}`
...
配置环境变量：
```
OIDC_ISSUER=https://sso${ENV_SUFFIX}.${INTERNAL_DOMAIN}/application/o/my-app
OIDC_CLIENT_ID=...
OIDC_CLIENT_SECRET=...
```
