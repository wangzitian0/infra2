...
(`Check infra2 host and alert bridge`). It excludes the route canary, deploy
guard audit, and other ops-checks tasks before reviewing structured watchdog
logs. The digest reviews alert recall evidence (`watchdog.delivery.success`,
