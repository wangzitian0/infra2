...
for (const [label, overrides] of [
  ...
  ["tinyInterval", { WATCHDOG_HEARTBEAT_MIN_WRITE_INTERVAL_SECONDS: "1" }],
  [
    "hugeBudget",
    { WATCHDOG_HEARTBEAT_STATUS_CHANGE_WRITES_PER_DAY: "100000", WATCHDOG_HEARTBEAT_MIN_WRITE_INTERVAL_SECONDS: "600" },
  ],
  [
    "malformedBudget",
